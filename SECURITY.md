...
- **Build Environment**: Local builds require `buildah >= 1.14.5` (CVE-2020-10696) and CI uses `buildkit >= 0.28.1` (CVE-2026-33747) to prevent host path traversal.
...
The active remediation inventory, RPM override workflow, and the current plan
for Trivy findings now live in [docs/cve-remediation.md](docs/cve-remediation.md).
